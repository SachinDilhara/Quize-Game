...
public class lor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.lor;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.lor.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.lor.size() - 1) {
            index++;
            modelClass = MainActivity.lor.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(lor.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.lor.size()) {
            modelClass = MainActivity.lor.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(lor.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
