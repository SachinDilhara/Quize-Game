...
public class mi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.mi;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.mi.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.mi.size() - 1) {
            index++;
            modelClass = MainActivity.mi.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(mi.this, wonActivity.class);
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mi.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
