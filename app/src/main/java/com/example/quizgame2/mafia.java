...
public class mafia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.mafia;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.mafia.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.mafia.size() - 1) {
            index++;
            modelClass = MainActivity.mafia.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(mafia.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.mafia.size()) {
            modelClass = MainActivity.mafia.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mafia.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
