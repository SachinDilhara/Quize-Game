...
public class uncharted extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.uncharted;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.uncharted.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.uncharted.size() - 1) {
            index++;
            modelClass = MainActivity.uncharted.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(uncharted.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.uncharted.size()) {
            modelClass = MainActivity.uncharted.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(uncharted.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
