...
public class nfs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.nfs;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.nfs.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.nfs.size() - 1) {
            index++;
            modelClass = MainActivity.nfs.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(nfs.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.nfs.size()) {
            modelClass = MainActivity.nfs.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(nfs.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
