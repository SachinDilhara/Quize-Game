...
public class uw extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.uw;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.uw.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.uw.size() - 1) {
            index++;
            modelClass = MainActivity.uw.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(uw.this, wonActivity.class);
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(uw.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
