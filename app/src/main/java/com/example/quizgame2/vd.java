...
public class vd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.vd;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.vd.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.vd.size() - 1) {
            index++;
            modelClass = MainActivity.vd.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(vd.this, wonActivity.class);
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(vd.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
