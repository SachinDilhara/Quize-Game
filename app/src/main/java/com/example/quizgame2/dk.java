...
public class dk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.dk;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.dk.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.dk.size() - 1) {
            index++;
            modelClass = MainActivity.dk.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(dk.this, wonActivity.class);
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(dk.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
