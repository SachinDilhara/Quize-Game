...
public class viking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.viking;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.viking.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.viking.size() - 1) {
            index++;
            modelClass = MainActivity.viking.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(viking.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.viking.size()) {
            modelClass = MainActivity.viking.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(viking.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
