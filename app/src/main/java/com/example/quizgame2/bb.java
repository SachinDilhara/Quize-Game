...
public class bb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.bb;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.bb.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.bb.size() - 1) {
            index++;
            modelClass = MainActivity.bb.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(bb.this, wonActivity.class);
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(bb.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
