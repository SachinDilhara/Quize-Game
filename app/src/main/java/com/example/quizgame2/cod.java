...
public class cod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.cod;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.cod.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.cod.size() - 1) {
            index++;
            modelClass = MainActivity.cod.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(cod.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.cod.size()) {
            modelClass = MainActivity.cod.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(cod.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
