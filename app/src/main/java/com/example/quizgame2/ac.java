...
public class ac extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.ac;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.ac.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.ac.size() - 1) {
            index++;
            modelClass = MainActivity.ac.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(ac.this, wonActivity.class);
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ac.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
