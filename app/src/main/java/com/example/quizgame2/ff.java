...
public class ff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.ff;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.ff.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.ff.size() - 1) {
            index++;
            modelClass = MainActivity.ff.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(ff.this, wonActivity.class);
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ff.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
