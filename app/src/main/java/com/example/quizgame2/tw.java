...
public class tw extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.tw;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.tw.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.tw.size() - 1) {
            index++;
            modelClass = MainActivity.tw.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(tw.this, wonActivity.class);
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(tw.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
