...
public class arkham extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.arkham;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.arkham.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.arkham.size() - 1) {
            index++;
            modelClass = MainActivity.arkham.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(arkham.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.arkham.size()) {
            modelClass = MainActivity.arkham.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(arkham.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
