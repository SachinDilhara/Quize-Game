...
public class got extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.got;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.got.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.got.size() - 1) {
            index++;
            modelClass = MainActivity.got.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(got.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.got.size()) {
            modelClass = MainActivity.got.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(got.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
