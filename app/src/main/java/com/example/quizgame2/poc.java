...
public class poc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.poc;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.poc.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.poc.size() - 1) {
            index++;
            modelClass = MainActivity.poc.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(poc.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.poc.size()) {
            modelClass = MainActivity.poc.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(poc.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
