...
public class gta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.gta;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.gta.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.gta.size() - 1) {
            index++;
            modelClass = MainActivity.gta.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(gta.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.gta.size()) {
            modelClass = MainActivity.gta.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(gta.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
