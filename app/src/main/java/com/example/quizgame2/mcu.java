...
public class mcu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.anotherListOfData;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.anotherListOfData.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.anotherListOfData.size() - 1) {
            index++;
            modelClass = MainActivity.anotherListOfData.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(mcu.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.anotherListOfData.size()) {
            modelClass = MainActivity.anotherListOfData.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mcu.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
