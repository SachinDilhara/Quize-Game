...
public class gow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.gow;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.gow.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.gow.size() - 1) {
            index++;
            modelClass = MainActivity.gow.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(gow.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.gow.size()) {
            modelClass = MainActivity.gow.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(gow.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
