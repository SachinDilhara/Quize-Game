...
public class jw extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.jw;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.jw.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.jw.size() - 1) {
            index++;
            modelClass = MainActivity.jw.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(jw.this, wonActivity.class);
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(jw.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
