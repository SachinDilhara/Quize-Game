...
public class twilight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.twilight;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.twilight.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.twilight.size() - 1) {
            index++;
            modelClass = MainActivity.twilight.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(twilight.this, wonActivity.class);
    ...
    public void nextbtnClick(View view) {
        ...
        index++;
        if (index < MainActivity.twilight.size()) {
            modelClass = MainActivity.twilight.get(index);
            setAllData();
            resetColors();
            enableButtons();
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(twilight.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
