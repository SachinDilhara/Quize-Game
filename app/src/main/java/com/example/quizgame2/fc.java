...
public class fc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allQuestionsList = MainActivity.fc;
        Collections.shuffle(allQuestionsList);
        modelClass = MainActivity.fc.get(index);
    ...
    public void wrong() {
        wrongcount++;
        if (index < MainActivity.fc.size() - 1) {
            index++;
            modelClass = MainActivity.fc.get(index);
            setAllData();
        } else {
    ...
    private void gamewon() {
        Intent intent = new Intent(fc.this, wonActivity.class);
    ...
    private void showTimeOutDialog() {
        ...
        dialog.findViewById(R.id.btnTryAgain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(fc.this, home.class);
                startActivity(intent);
                dialog.dismiss();
            }
        });
